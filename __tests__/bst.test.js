...
describe('binarySearchTree', () => {
  ...
  test('it should add a child to the left of the child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insert(rootNode);
  ...
  test('it should add a child to the right of the child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insert(rootNode);
  ...
  test('it should add a child to the left of the right of the child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insert(rootNode);
    let node2 = new BSTNode(22);
